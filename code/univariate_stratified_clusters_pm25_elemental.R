...
# cluster.list <- c("geographyCluster")
varlist <- c( "pm25_Cu", "pm25_Fe", "pm25_K", "pm25_Ni", "pm25_S", "pm25_Si", "pm25_V", "pm25_Zn")
# varlist <- c("pm25_Fe", "pm25_K", "pm25_Ni", "pm25_S", "pm25_Si", "pm25_V", "pm25_Zn")
